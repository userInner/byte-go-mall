...
func (x *AddItemResp) GetStatus() *base.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *GetCartResp) GetStatus() *base.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *EmptyCartResp) GetStatus() *base.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
var file_cart_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x1a, 0x0a, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x68,
	...
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x70, 0x72, 0x6f,
	0x64, 0x75, 0x63, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x49, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x49,
	...
	0x74, 0x65, 0x6d, 0x22, 0x33, 0x0a, 0x0b, 0x41, 0x64, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65,
	...
	0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x27, 0x0a, 0x0c, 0x45, 0x6d, 0x70, 0x74,
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x53, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x43,
	...
	0x74, 0x52, 0x04, 0x63, 0x61, 0x72, 0x74, 0x12, 0x24, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	...
	0x74, 0x65, 0x6d, 0x73, 0x22, 0x35, 0x0a, 0x0d, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x43, 0x61, 0x72,
	...
	0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0xa9, 0x01, 0x0a, 0x0b,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x1d, 0x5a, 0x1b, 0x62, 0x79, 0x74, 0x65, 0x2d,
	0x67, 0x6f, 0x2d, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78, 0x5f, 0x67, 0x65,
...
var file_cart_proto_depIdxs = []int32{
	...
	8, // 1: cart.AddItemResp.status:type_name -> base.Status
	6, // 2: cart.GetCartResp.cart:type_name -> cart.Cart
	8, // 3: cart.GetCartResp.status:type_name -> base.Status
	0, // 4: cart.Cart.items:type_name -> cart.CartItem
	8, // 5: cart.EmptyCartResp.status:type_name -> base.Status
	1, // 6: cart.CartService.AddItem:input_type -> cart.AddItemReq
	4, // 7: cart.CartService.GetCart:input_type -> cart.GetCartReq
	3, // 8: cart.CartService.EmptyCart:input_type -> cart.EmptyCartReq
